        ...
        <div className="mt-8 grid grid-cols-2 gap-x-6 gap-y-5 border-t border-[color:var(--outline-soft)] pt-6 sm:grid-cols-4">
          {stats.map((stat) => (
            <div key={stat.label}>
              ...
              <div className="mt-1 font-mono text-[0.7rem] uppercase tracking-[0.16em] text-[color:var(--header-kicker-text)]">
                {stat.label}
              </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch">
          <div className="flex flex-1 flex-col gap-5 p-6 lg:flex-row lg:items-start">
            ...
            <div className="min-w-0 flex-1">
              <span className="font-mono text-xs font-medium uppercase tracking-[0.24em] text-[color:var(--header-kicker-text)]">About</span>
          ...
          <>
            <div className="flex flex-col gap-3 text-sm sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-wrap items-center gap-3">
                <span className="font-mono text-xs font-medium uppercase tracking-[0.24em] text-[color:var(--header-kicker-text)]">
                  Featured Board
                </span>
                  ...
                  <div className="mt-5 flex items-center gap-1.5">
                    {featuredBoardProjects.map((project, index) => (
                      <button
                        ...
                        className="relative h-2.5 w-9 rounded-full bg-[var(--outline-soft)] transition-colors after:absolute after:-inset-y-2.5 after:inset-x-0 hover:bg-[var(--text-muted)]"
