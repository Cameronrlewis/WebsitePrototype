...
export const experience: ExperienceRecord[] = [
  ...
  },
  {
    ...
    markerLight: `${assetBase}/media/experience/horizon-logo-light.png`,
    bullets: [
      "Member of the avionics sub-team on Memorial University's student rocketry team, which designs, builds, and tests a Class FAA2 high-power rocket for Launch Canada 2026 in Timmins, Ontario.",
      "Designing the camera module PCB that records multiple angles of the rocket through launch, descent, and recovery, powered from a single 3S LiPo.",
      "Architected the board around three buck converters, with enable-gated rails for a DJI O4 Air unit and three RunCam modules plus an always-on rail for four 5V cooling fans, and a 3.3V LDO supplying an STM32G0 that drives the enable signals and fan-control PWM.",
    ],
  ...
  },
  {
    ...
    markerLight: `${assetBase}/media/experience/valiant-logo-light.png`,
    bullets: [
      "Member of the electrical team on Memorial University's uncrewed aerial systems design team, which builds autonomous aircraft for wildfire and urban firefighting response.",
      "Providing general electrical support to the team and beginning development on a power distribution board for the aircraft, with simulation, development, and assembly planned as coursework allows.",
      "Building toward AEAC 2027 in Medicine Hat, Alberta, following the team's 3rd place overall finish at AEAC 2026 in Ottawa.",
    ],
    tags: ["UAS", "Power Distribution", "PCB Design", "Simulation", "Electrical Support"],
  },
];
...
export const stats: StatRecord[] = [
  ...
  { label: "Experience", value: String(experience.length), detail: "engineering roles" },
    ...
    builds: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Desoldered the capacitor from both buck circuits on the board, then powered it back on and both rails came up cleanly with no flashing.",
        ],
      ...
      },
      {
        ...
        media: `${assetBase}/media/projects/brick-buck-kart-testing.webp`,
    ...
    builds: [
      {
        ...
        bullets: [
          ...
          "Kept the thermal rail always-on: a third buck drives four 5V DC fans that cool the cameras, so cooling never depends on the same enable logic that gates the video hardware.",
          "Added a 3.3V LDO for an STM32G0 that owns the enable signals for both gated bucks and the PWM that sets fan speed, keeping the control logic on a quiet rail of its own.",
        ],
        tags: ["Buck Converters", "STM32G0", "PWM", "3S LiPo", "Thermal Management"],
      },
    ],
  },
  {
    ...
    overview: [
      "Valiant Aerotech is Memorial University's student uncrewed aerial systems team, building autonomous aircraft for wildfire and urban firefighting response and competing in the AEAC National Student UAS Competition. The team placed 3rd overall at AEAC 2026 in Ottawa and is now preparing for AEAC 2027 in Medicine Hat, Alberta, in May 2027.",
      "I joined the electrical team in June 2026, providing general electrical support and starting development on a power distribution board for the aircraft. Coursework limits how much time I can give the team right now, so the board is still early; the plan is to put full bandwidth into its simulation, development, and assembly as my schedule opens up.",
    ],
    tags: ["UAS", "Power Distribution", "PCB Design", "Simulation", "Electrical Support"],
    logo: `${assetBase}/media/experience/valiant-logo.png`,
    logoLight: `${assetBase}/media/experience/valiant-logo-light.png`,
    builds: [
      {
        ...
        bullets: [
          "Scoping the distribution board around the aircraft's existing electrical layout rather than designing it in isolation from what the team already flies.",
          "Providing electrical support to the team in the meantime, which keeps me close to how the current hardware behaves before the board is locked in.",
          "Simulation, development, and assembly are the next phases once coursework frees up the time to work on it properly.",
        ],
        tags: ["Power Distribution", "PCB Design", "Simulation", "Early Development"],
      },
    ],
  },
  {
...
export function parseWeekSortKey(week: string): number {
